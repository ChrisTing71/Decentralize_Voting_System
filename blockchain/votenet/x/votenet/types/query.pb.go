...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7965235afe18395a, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7965235afe18395a, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "votenet.votenet.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "votenet.votenet.QueryParamsResponse")
}

func init() { proto.RegisterFile("votenet/votenet/query.proto", fileDescriptor_7965235afe18395a) }

var fileDescriptor_7965235afe18395a = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2e, 0xcb, 0x2f, 0x49,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x92, 0xa3, 0x2b, 0xad,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/votenet.votenet.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/votenet.votenet.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "votenet.votenet.Query",
	...
	Metadata: "votenet/votenet/query.proto",
}
